function init_flowchart(divFlowchart, divPalette, load) {
  ...
  d_flow.nodeTemplateMap.add("",  // the default category
  ...
  d_flow.nodeTemplateMap.add("Conditional",
    $(go.Node, "Table", nodeStyle(),
      // the main object is a Panel that surrounds a TextBlock with a rectangular Shape
      $(go.Panel, "Auto",
        $(go.Shape, "Diamond",
  ...
  d_flow.nodeTemplateMap.add("Start",
    $(go.Node, "Table", nodeStyle(),
      $(go.Panel, "Spot",
        $(go.Shape, "Circle",
  ...
  d_flow.nodeTemplateMap.add("End",
    $(go.Node, "Table", nodeStyle(),
      $(go.Panel, "Spot",
        $(go.Shape, "Circle",
  ...
  d_flow.nodeTemplateMap.add("Comment",
    ...
    $(go.Palette, "divPalette",  // must name or refer to the DIV HTML element
      {
        ...
        nodeTemplateMap: d_flow.nodeTemplateMap,  // share the templates used by d_flow
